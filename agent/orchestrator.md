...
4. **Enhanced Memory Integration**: Load success patterns, failure patterns, templates, and intelligence from ~/.config/opencode/orchestrator/memory
...
1. **Read existing memory files for context:**
   - Read ~/.config/opencode/orchestrator/memory/success_patterns.json
   - Read ~/.config/opencode/orchestrator/memory/failure_patterns.json
   - Read ~/.config/opencode/orchestrator/memory/project_templates.json
   - Read ~/.config/opencode/orchestrator/memory/learning_metrics.json

2. **Read intelligence files:**
   - Read ~/.config/opencode/orchestrator/memory/codebase_intelligence.json
   - Read ~/.config/opencode/orchestrator/memory/git_patterns.json
   - Read ~/.config/opencode/orchestrator/memory/library_insights.json
   - Read ~/.config/opencode/orchestrator/memory/research_metrics.json
...
The orchestrator learns from past projects by maintaining enhanced memory files in `~/.config/opencode/orchestrator/memory/`:
